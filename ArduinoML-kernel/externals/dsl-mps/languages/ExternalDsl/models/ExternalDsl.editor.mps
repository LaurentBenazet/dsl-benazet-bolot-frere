...
<model ref="r:a28e0cfb-781a-4c91-81a4-1abe534238fe(ExternalDsl.editor)">
  ...
  <node concept="24kQdi" id="2RsYsllZyBQ">
    ...
    <node concept="3EZMnI" id="2RsYsllZySq" role="2wV5jI">
      <node concept="3EZMnI" id="2RsYsllZyST" role="3EZMnx">
        ...
        <node concept="3F0ifn" id="2RsYsllZyUq" role="3EZMnx">
          <property role="3F0ifm" value="initial:" />
        </node>
        <node concept="3F0A7n" id="2RsYsllZyUE" role="3EZMnx">
          <ref role="1NtTu8" to="heqe:2RsYsllZeB3" resolve="is_initial" />
        </node>
        <node concept="l2Vlx" id="2RsYsllZySY" role="2iSdaV" />
      </node>
      <node concept="3EZMnI" id="2RsYsllZByJ" role="3EZMnx">
        <node concept="VPM3Z" id="2RsYsllZByL" role="3F10Kt" />
        <node concept="3XFhqQ" id="2RsYsllZBzN" role="3EZMnx" />
        <node concept="3F2HdR" id="2RsYsllZBzT" role="3EZMnx">
          <ref role="1NtTu8" to="heqe:2RsYsllZ3fR" resolve="actions" />
          <node concept="l2Vlx" id="2RsYsllZBzV" role="2czzBx" />
          <node concept="3F0ifn" id="2RsYsllZBzZ" role="2czzBI">
            <property role="3F0ifm" value="no action defined" />
          </node>
        </node>
        <node concept="l2Vlx" id="2RsYsllZByO" role="2iSdaV" />
      </node>
      <node concept="3EZMnI" id="2RsYsllZBzk" role="3EZMnx">
        <node concept="VPM3Z" id="2RsYsllZBzm" role="3F10Kt" />
        <node concept="3XFhqQ" id="2RsYsllZB$1" role="3EZMnx" />
        <node concept="3F0ifn" id="2RsYsllZB$7" role="3EZMnx">
          <property role="3F0ifm" value="going to" />
        </node>
        <node concept="1iCGBv" id="2RsYsllZB$f" role="3EZMnx">
          <ref role="1NtTu8" to="heqe:2RsYsllZ3fT" resolve="next" />
          <node concept="1sVBvm" id="2RsYsllZB$h" role="1sWHZn">
            <node concept="3F0A7n" id="2RsYsllZB$q" role="2wV5jI">
              <property role="1Intyy" value="true" />
              <ref role="1NtTu8" to="tpck:h0TrG11" resolve="name" />
            </node>
          </node>
        </node>
        <node concept="l2Vlx" id="2RsYsllZBzp" role="2iSdaV" />
      </node>
      <node concept="3F0ifn" id="2RsYsllZB$t" role="3EZMnx">
        <property role="3F0ifm" value=" " />
      </node>
  ...
  <node concept="24kQdi" id="2RsYsllZNax">
    ...
    <node concept="3EZMnI" id="2RsYsllZNaz" role="2wV5jI">
      ...
      <node concept="2iRkQZ" id="2RsYsllZNcl" role="2iSdaV" />
    </node>
  </node>
</model>
