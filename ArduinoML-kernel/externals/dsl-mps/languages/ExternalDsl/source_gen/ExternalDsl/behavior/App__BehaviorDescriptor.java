...
public final class App__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x36b21cb1227440d2L, 0x9f74baf372272c13L, 0x2ddcf9c555fc33d7L, "ExternalDsl.structure.App");
  ...
  /*package*/ static Scope getScope_id52_Geb4QDV$(@NotNull SNode __thisNode__, SAbstractConcept kind, SNode child) {
    if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(kind), CONCEPTS.State$uf)) {

      return SimpleRoleScope.forNamedElements(__thisNode__, LINKS.states$$ljF);
    }
    if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(kind), CONCEPTS.Actuator$th)) {

      return SimpleRoleScope.forNamedElements(__thisNode__, LINKS.actuators$$lkD);
    }
    return null;
  }
