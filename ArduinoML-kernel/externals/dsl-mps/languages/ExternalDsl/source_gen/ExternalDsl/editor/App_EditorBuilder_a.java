...
/*package*/ class App_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class actuatorsListHandler_g38wqt_b2a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(actuatorsListHandler_g38wqt_b2a.this.getNode(), LINKS.actuators$$lkD));
      try {
  ...
  private static class statesListHandler_g38wqt_b4a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(statesListHandler_g38wqt_b4a.this.getNode(), LINKS.states$$ljF));
      try {
        EditorCell emptyCell = null;
