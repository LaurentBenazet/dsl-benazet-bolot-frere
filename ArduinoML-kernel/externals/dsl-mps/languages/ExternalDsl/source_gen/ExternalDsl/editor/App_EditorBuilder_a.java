...
/*package*/ class App_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.freq$Mu$q;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_g38wqt_a3c0();
  ...
  private boolean nodeCondition_g38wqt_a3c0() {
    return !(SPropertyOperations.hasValue(myNode, PROPS.freq$Mu$q, null));
  }
  private EditorCell createConstant_3() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Hz");
    editorCell.setCellId("Constant_g38wqt_a3c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createEmpty_0() {
    ...
    editorCell.setCellId("Empty_g38wqt_a3c0");
    return editorCell;
  }
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new actuatorsListHandler_g38wqt_b4a(myNode, getEditorContext());
  ...
  private static class actuatorsListHandler_g38wqt_b4a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.actuators$$lkD;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.Actuator$th;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(actuatorsListHandler_g38wqt_b4a.this.getNode(), LINKS.actuators$$lkD));
      try {
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new sensorsListHandler_g38wqt_b6a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
  ...
  private static class sensorsListHandler_g38wqt_b6a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public sensorsListHandler_g38wqt_b6a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.sensors$xOD2;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.Sensor$tK;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(sensorsListHandler_g38wqt_b6a.this.getNode(), LINKS.sensors$xOD2));
      try {
        EditorCell emptyCell = null;
  ...
  private static class statesListHandler_g38wqt_b8a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.states$$ljF;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.State$uf;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(statesListHandler_g38wqt_b8a.this.getNode(), LINKS.states$$ljF));
      try {
        EditorCell emptyCell = null;
  ...
  private EditorCell createConstant_10() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, " ");
    editorCell.setCellId("Constant_g38wqt_j0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  private EditorCell createRefNodeList_3() {
    AbstractCellListHandler handler = new errorsListHandler_g38wqt_b01a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
  ...
  private static class errorsListHandler_g38wqt_b01a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public errorsListHandler_g38wqt_b01a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.errors$gebC;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.Error$4J;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(errorsListHandler_g38wqt_b01a.this.getNode(), LINKS.errors$gebC));
      try {
        EditorCell emptyCell = null;
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept Sensor$tK = MetaAdapterFactory.getConcept(0x36b21cb1227440d2L, 0x9f74baf372272c13L, 0x2ddcf9c555fc33d4L, "ExternalDsl.structure.Sensor");
