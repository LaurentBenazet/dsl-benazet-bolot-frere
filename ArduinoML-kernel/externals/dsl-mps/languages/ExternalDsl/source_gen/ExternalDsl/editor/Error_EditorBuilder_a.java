...
/*package*/ class Error_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Throw error");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.name$$q_z;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
      editorCell.setDefaultText("<error number>");
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_t62t42_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.actu$vMuE;
    ...
    provider.setNoTargetText("<no actu>");
    EditorCell editorCell = provider.createCell();

    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.actu$vMuE);
    }
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_t62t42_e0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new conditionsListHandler_t62t42_f0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Horizontal(), false);
    editorCell.setCellId("refNodeList_conditions");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class conditionsListHandler_t62t42_f0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public conditionsListHandler_t62t42_f0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.conditions$G2nx;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.Condition$g9;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(conditionsListHandler_t62t42_f0.this.getNode(), LINKS.conditions$G2nx));
      try {
